...
namespace Property_management_system.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        [HttpPut("select/{itemId}")]
        public async Task<IActionResult> SelectItem(Guid itemId, [FromBody] UpdateCartItemSelectionDto dto)
        {
            var success = await cartRepository.UpdateSelectionAsync(itemId, dto.Selected);
