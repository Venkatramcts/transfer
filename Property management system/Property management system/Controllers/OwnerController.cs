...
namespace Property_management_system.Controllers
{
    ...
    public class OwnerController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateOwner([FromBody] CreateOwnerRequestDto request)
        {
        ...
        [HttpPut("{id:Guid}")]
        [Authorize(Roles = "Owner,Admin")]
        public async Task<IActionResult> UpdateOwner([FromRoute] Guid id, [FromBody] UpdateOwnerRequestDto request)
        {
